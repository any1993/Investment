...
$(function () {
    if (sessionStorage.W_UserID != undefined && sessionStorage.W_UserID != null && sessionStorage.W_UserID != "null") {
        ...
        //UserID = 'br_' + getRandom(1000000000);
        UserID = "br_1091827413";
        sessionStorage.W_UserID = UserID;
    }
    function getRandom(n) {
        return Math.floor(Math.random() * n + 1000000000)
    };
    $(window).scrollTop(0);
    Touch();

    // httpGet('https://api.palaspom.com/Reader/StockAverageRateInfos?stockId=sh600004&fromTime=1453078828000&endTime=1484614828000', "", true, ajax_success1, ajax_fail1);
    // function ajax_success1(){
...
function Touch() {
    $("#K_title_hour").bind("click", function () {
        if (click_able) {
    ...
    $("#K_title_five").bind("click", function () {
        if (click_able) {
            if (!$(this).hasClass("K_title_box_clicked")) {
                click_able = false;
                K_type = "B";
    ...
    $("#K_title_day").bind("click", function () {
        if (click_able) {
            if (!$(this).hasClass("K_title_box_clicked")) {
                click_able = false;
                K_type = "C";
                ...
                if (C_TicktimeData != "" && C_TradeData != "" && C_AmountData != "" && C_AmountDataColor != "") {
                    ...
                    iNowString = Date.parse(new Date());
                    iFromString = iNowString - 90 * 24 * 60 * 60 * 1000;//获取一个时间90天前的时间戳  13位
                    //日K(90天)
                    StockHistoryType = 0;
                    openDaysCount = 90;
                    echarts_loading();
    ...
    $("#K_title_week").bind("click", function () {
        if (click_able) {
            if (!$(this).hasClass("K_title_box_clicked")) {
                click_able = false;
                K_type = "D";
                ...
                if (D_TicktimeData != "" && D_TradeData != "" && D_AmountData != "" && D_AmountDataColor != "") {
                    ...
                    iNowString = Date.parse(new Date());
                    iFromString = iNowString - 365 * 24 * 60 * 60 * 1000;
                    //周K(一年)
                    StockHistoryType = 1;
                    openDaysCount = 365;
                    echarts_loading();
    ...
    $("#K_title_mouth").bind("click", function () {
        if (click_able) {
            if (!$(this).hasClass("K_title_box_clicked")) {
                click_able = false;
                K_type = "E";
                ...
                if (E_TicktimeData != "" && E_TradeData != "" && E_AmountData != "" && E_AmountDataColor != "") {
                    ...
                    iNowString = Date.parse(new Date());
                    iFromString = iNowString - 1825 * 24 * 60 * 60 * 1000;
                    //月K
                    StockHistoryType = 3;
                    openDaysCount = 1825;
                    echarts_loading();
    ...
    // $("#stock_bulish_title").bind("click", function () {
    //     if (!$(this).hasClass("K_title_box_clicked")) {
    //         $(this).addClass("K_title_box_clicked");
    //         $(this).siblings().removeClass("K_title_box_clicked");
    ...
    //     }
    // })
    // $("#stock_topic_title").bind("click", function () {
    //     if (!$(this).hasClass("K_title_box_clicked")) {
    //         $(this).addClass("K_title_box_clicked");
    //         $(this).siblings().removeClass("K_title_box_clicked");
    ...
    //     }
    // })
    $("#stock_heroes_title").bind("click", function () {
        if (!$(this).hasClass("K_title_box_clicked")) {
            $(this).addClass("K_title_box_clicked");
            $(this).siblings().removeClass("K_title_box_clicked");
    ...
    $("#stock_warehouse_title").bind("click", function () {
        if (!$(this).hasClass("K_title_box_clicked")) {
            $(this).addClass("K_title_box_clicked");
            $(this).siblings().removeClass("K_title_box_clicked");
    ...
    $("#stock_bodies_title").bind("click", function () {
        if (!$(this).hasClass("K_title_box_clicked")) {
            $(this).addClass("K_title_box_clicked");
            $(this).siblings().removeClass("K_title_box_clicked");
    ...
    $("#profit_box_title").bind("click", function () {
        if (!$(this).hasClass("K_title_box_clicked")) {
            $(this).addClass("K_title_box_clicked");
            $(this).siblings().removeClass("K_title_box_clicked");
    ...
    $(".analyse_title div").each(function (i) {
    ...
    $("#onlyProfit").bind("click", function () {
    ...
    $('#stock_addChose').bind('click', function () {
        if (!$('#stock_addChose').hasClass('UnableAdd')) {
            ...
            //个股取消自选
            httpGet("Reader/DelUserStocks/" + stockId + "?userID=" + UserID + "&type=0", "", true, ajax_success6, ajax_fail6);
        ...
        if (obj != null && obj != "" && obj != undefined && obj.length > 0) {
            ...
            if (obj[0].Pricechange > 0) {
                ...
                if (obj[0].Pricechange < 0) {
                    ...
                    // $('#stock_top,#stock_title').css('background-color', '#2B68B8');
                    // $("#stock_status").html("停牌中");
                }
            }
                ...
                xAxis: [
                    {
                        ...
                        axisLabel: {
                            ...
                            //     if ((index % 15 === 0 && hour <= 9 && Minutes < 25) || ((index - 11) % 10 === 0 && ((hour < 12 && hour > 9) || (hour <= 9 && Minutes > 25))) || ((index - 132) != 0 && (index - 132) % 10 === 0 && hour > 12)) {
                            //         return true;
                            //     }
                            //     else {
                            //         return false;
...
function Relate_Topic() {
    httpGet("Reader/StockBlock?stockID=" + stockId, "", true, ajax_success10, ajax_fail10);
...
function main_forces() {
    //获取资金流向
    httpGet("Reader/CapitalFlow/" + stockId + "?type=0&skipHour=24&fromTime=" + iFromString2 + "&endTime=" + iNowString2, "", true, ajax_success11, ajax_fail11);
            ...
            function ajax_success3(obj) {
                if (obj != null && obj != "" && obj != undefined) {
                    ...
                    for (var z = 0; z < forcesXAxis.length; z++) {
                        // alert("MainForceColor" + z + ":" + MainForceColor[z]);
...
function main_heroes() {
    ...
    $('#mai_out_click,#mai_NormalOut_click').bind('click', function () {
        $("#heroes_table,#heroes_table2").addClass("Page");
        $("#heroes_table1").removeClass("Page");
    })
    $('#mai_in_click,#mai_NormalIn_click').bind('click', function () {
        $("#heroes_table1,#heroes_table2").addClass("Page");
        $("#heroes_table").removeClass("Page");
    })
    //三个月内龙虎榜买入排序
    httpGet("Reader/StockBillbordDetail?stockID=" + stockId + "&fromTime=" + iFromString3 + "&endTime=" + iNowString3 + "&sortType=0&maxCount=5", "", true, ajax_success12, ajax_fail12);
    ...
    //三个月内龙虎榜卖出排序
    httpGet("Reader/StockBillbordDetail?stockID=" + stockId + "&fromTime=" + iFromString3 + "&endTime=" + iNowString3 + "&sortType=2&maxCount=5", "", true, ajax_success2, ajax_fail2);
    function ajax_success2(obj) {
        if (obj != null && obj != "" && obj != undefined) {
            if (obj.length > 0) {
                for (var i = 0; i < obj.length; i++) {
...
function main_warehouse() {
    ...
    httpGet("Reader/StockInvestAdjustRecord?stockID=" + stockId + "&fromTime=" + iFromString3 + "&endTime=" + iNowString3 + "&maxCount=5", "", true, ajax_success13, ajax_fail13);
    ...
    option4 = {
        ...
        series: [
            ...
            },
            {
                ...
                itemStyle: { normal: { color: '#3095ff' } },//蓝色的平均线
            },
        ]
    };
...
//获取热评
function bottom_A() {
    httpGet("Reader/StockHotJudge?stockID=" + stockId + "&from=" + from0 + "&size=10", "", true, ajax_success14, ajax_fail14);
...
//获取观点
function bottom_B() {
    httpGet("Reader/StockPoint?stockID=" + stockId + "&from=" + from1 + "&size=10", "", true, ajax_success15, ajax_fail15);
...
//获取新闻
function bottom_C() {
    httpGet("Reader/StockNews?stockID=" + stockId + "&from=" + from2 + "&size=3", "", true, ajax_success16, ajax_fail16);
        ...
        if (obj != null && obj != "" && obj != undefined) {
            ...
            if (obj.length > 0) {
                ...
                for (var i = 0; i < obj.length; i++) {
                    ...
                    // strlist += '<li id="' + obj[i].NewsID + '"><p>' + obj[i].NewsTitle + '</p><p class="relate-date">' + GetTimeRegular(obj[i].NewsTime) + '</p></li>';
                }
...
//获取公告
function bottom_D() {
    httpGet("Reader/StockAnnouncements?stockID=" + stockId + "&from=" + from3 + "&size=10", "", true, ajax_success17, ajax_fail17);
...
//获取研报
function bottom_E() {
    httpGet("Reader/StockReports?stockID=" + stockId + "&from=0&size=10", "", true, ajax_success18, ajax_fail18);
...
//获取资料
function bottom_F() {
    httpGet("Reader/stockBasicInfo?stockID=" + stockId, "", true, ajax_success19, ajax_fail19);
...
function bind_indexlist(id) {
    $('#' + id).bind("click", function () {
        ...
        // window.location.href = 'newsInfo.html?itemid=' + id + '&newsType=1' + '&fromPage=stock&stockId=' + stockId;
    })
}
//相关公告点击绑定
function bind_indexlist2(id) {
    $('#' + id).bind("click", function () {
        ...
        // window.location.href = 'Announcement.html?AnnouncementId=' + id + '&fromPage=stock&stockId=' + stockId;
    })
}
//相关研报点击绑定
function bind_indexlist3(id) {
    $('#' + id).bind("click", function () {
        ...
        // window.location.href = 'Reports.html?ReportsId=' + id + '&fromPage=stock&stockId=' + stockId;
    })
}
//相关主题的点击
        ...
        if ($(this).scrollTop() + $(this).height() == $(document).height()) {
            ...
            if (Bottom_type == 0) {
                if (from0 != 0) {
                    ...
                    if (from0 % 10 == 0) {
                        httpGet("Reader/StockHotJudge?stockID=" + stockId + "&from=" + from0 + "&size=10", "", true, ajax_success20, ajax_fail20);
            ...
            else if (Bottom_type == 1) {
                if (from1 != 0) {
                    $('#stock_loading').removeClass('Page');
                    if (from1 % 10 == 0) {
                        httpGet("Reader/StockPoint?stockID=" + stockId + "&from=" + from1 + "&size=10", "", true, ajax_success1, ajax_fail1);
                        function ajax_success1(obj) {
                            if (obj != null && obj != "" && obj != undefined) {
                                var strlist = "";
                                if (obj.length > 0) {
                ...
                if (from2 != 0) {
                    $('#stock_loading').removeClass('Page');
                    if (from2 % 3 == 0) {
                        httpGet("Reader/StockNews?stockID=" + stockId + "&from=" + from2 + "&size=3", "", true, ajax_success1, ajax_fail1);
                        function ajax_success1(obj) {
                            if (obj != null && obj != "" && obj != undefined) {
                                var strlist = "";
                                if (obj.length > 0) {
                ...
                if (from3 != 0) {
                    $('#stock_loading').removeClass('Page');
                    if (from3 % 10 == 0) {
                        httpGet("Reader/StockAnnouncements?stockID=" + stockId + "&from=0&size=10", "", true, ajax_success1, ajax_fail1);
                        function ajax_success1(obj) {
                            if (obj != null && obj != "" && obj != undefined) {
                                var strlist = "";
                                if (obj.length > 0) {
