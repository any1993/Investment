...
public class IndexShenFragment extends BaseFragment {

    @BindView(R.id.tv_stock_shen)
    TextView tvStockType;
    @BindView(R.id.tv_shen_price)
    TextView tvStockSettlement;
    @BindView(R.id.tv_shen)
    TextView tvUpDown;
    @BindView(R.id.tv_shen_asset)
    TextView tvAsset;
    @BindView(R.id.shen_chart)
    LineChart lineChart;
    ...
    private void getEmotionIndex() {
        ...
        OkGo.<List<Emotion>>get(Constant.STOCK_SHEN)
                .tag(activity)
                .headers("Authorization", token)
                .params("type", 0)
                .params("count", 5)
    ...
    private void getAssetData() {
        ...
        OkGo.<List<Asset>>get(Constant.ASSET_SHEN)
                .tag(activity)
                .headers("Authorization", token)
                .params("type", 0)
                .params("skipHour", 1)
                ...
                .execute(new JsonCallBack<List<Asset>>(type) {
                    ...
                    public void onSuccess(Response<List<Asset>> response) {
                        ...
                        if (mainForce > 0) {
                            ...
                            tvAsset.setText("深证成指 流入 " + CommonUtils.setDoubleTwo(mainForce / 10000) + "亿");
                        } else if (mainForce < 0) {
