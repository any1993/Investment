 ...
 */
public class FixedIncomeFragment extends BaseFragment implements View.OnClickListener
    ...
    private String[] value_invest = {"8", "7"}, value_type = {"1", "2", "3", "4"}, date_value = {"-1", "1", "2", "3", "4", "5", "6"},
        ...
        if (isChecked) {
            switch (buttonView.getId()) {
                case R.id.cb_cache:
                    ...
                    break;
                case R.id.cb_fixed_income:
                    if (rbNoInvest.isChecked())
                        rbNoInvest.setChecked(false);
                    break;
                case R.id.rb_no_invest:
                    resetButton(investCb, rbNoInvest);
                    break;
                case R.id.cb_bank:
                    if (rbNoType.isChecked())
    ...
    public void initInvestPopupWindow() {
        //创建popupWindow对象
        final View investPop = getActivity().getLayoutInflater().inflate(R.layout.ppw_invest, null);
        //初始化popupWindow对象
        ...
        CheckBox cbCache = (CheckBox) investPop.findViewById(R.id.cb_cache);
        CheckBox cbFixedIncome = (CheckBox) investPop.findViewById(R.id.cb_fixed_income);
        rbNoInvest = (RadioButton) investPop.findViewById(R.id.rb_no_invest);
        View view = investPop.findViewById(R.id.view_grey);
        rbNoInvest.setChecked(true);
        cbCache.setOnCheckedChangeListener(this);
        cbFixedIncome.setOnCheckedChangeListener(this);
        rbNoInvest.setOnCheckedChangeListener(this);
        investCb.add(cbFixedIncome);
        investCb.add(cbCache);
    ...
    public void initTypePopWindow() {
        //创建popupWindow对象
        View typePop = getActivity().getLayoutInflater().inflate(R.layout.ppw_type, null);
        //初始化popupWindow对象
        ...
        //初始化popupWindow的布局中的其他控件
        CheckBox cbBank = (CheckBox) typePop.findViewById(R.id.cb_bank);
        ...
        rbNoType = (RadioButton) typePop.findViewById(R.id.rb_no_type);
